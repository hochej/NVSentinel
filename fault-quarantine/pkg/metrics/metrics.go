...
var (
	...
	FaultQuarantineBreakerUtilization = promauto.NewGauge(
		prometheus.GaugeOpts{
			...
			Help: "Fraction of scoped circuit breaker nodes recently cordoned.",
		},
	)
	FaultQuarantineGetTotalNodesDuration = promauto.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "fault_quarantine_get_total_nodes_duration_seconds",
			Help:    "Duration of circuit breaker node count calls in seconds.",
			Buckets: prometheus.DefBuckets,
		},
		[]string{"result"},
	)
	FaultQuarantineGetTotalNodesErrors = promauto.NewCounterVec(
		prometheus.CounterOpts{
			...
			Help: "Total number of errors from circuit breaker node count calls.",
		},
		[]string{"error_type"},
	)
	FaultQuarantineGetTotalNodesRetryAttempts = promauto.NewHistogram(
		prometheus.HistogramOpts{
			...
			Help:    "Number of retry attempts needed for circuit breaker node counts.",
